...
Verified Template Partners are part of Railway's official partner program and receive a 25% kickback rate. Verified partner templates receive significant benefits:
...
Learn more on our Verified Partner Program page
