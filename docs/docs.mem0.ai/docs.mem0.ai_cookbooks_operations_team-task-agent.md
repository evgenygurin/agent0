# Collaborative Task Assistant - Mem0
...
## ​Overview
[​](https://docs.mem0.ai/cookbooks/operations/team-task-agent#overview)
## ​Setup
[​](https://docs.mem0.ai/cookbooks/operations/team-task-agent#setup)
```
...
## ​Full Code Example
[​](https://docs.mem0.ai/cookbooks/operations/team-task-agent#full-code-example)
```
...
## ​Usage
[​](https://docs.mem0.ai/cookbooks/operations/team-task-agent#usage)
```
# Example usage
...
## ​Key Points
[​](https://docs.mem0.ai/cookbooks/operations/team-task-agent#key-points)- Each message is attributed to a user or agent (actor)
...
## ​Conclusion
[​](https://docs.mem0.ai/cookbooks/operations/team-task-agent#conclusion)[Build AI with PersonalityLearn how to scope memories across users and agents for team workflows.](https://docs.mem0.ai/cookbooks/essentials/building-ai-with-personality)
## Build AI with Personality
[Support Inbox with Mem0Apply collaborative memory patterns to customer support scenarios.](https://docs.mem0.ai/cookbooks/operations/support-inbox)
