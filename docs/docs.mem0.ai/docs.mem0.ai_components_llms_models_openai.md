...
## ​Usage
[​](https://docs.mem0.ai/components/llms/models/openai#usage)
```
import os
...
## ​Config
[​](https://docs.mem0.ai/components/llms/models/openai#config)`openai`[Master List of All Params in Config](https://docs.mem0.ai/components/llms/config)