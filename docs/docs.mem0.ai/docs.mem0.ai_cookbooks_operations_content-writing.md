# Content Creation Workflow - Mem0
...
## ​Why Use Mem0?
[​](https://docs.mem0.ai/cookbooks/operations/content-writing#why-use-mem0%3F)- Store persistent writing preferencesensuring consistent tone, formatting, and structure.
- Automate content refinementby retrieving preferences when rewriting or reviewing content.
- Scale your writing styleso it applies consistently across multiple documents or sessions.

## ​Setup
[​](https://docs.mem0.ai/cookbooks/operations/content-writing#setup)
```
import os
...
[​](https://docs.mem0.ai/cookbooks/operations/content-writing#storing-your-writing-preferences-in-mem0)
```
...
[​](https://docs.mem0.ai/cookbooks/operations/content-writing#editing-content-using-stored-preferences)
```
...
[​](https://docs.mem0.ai/cookbooks/operations/content-writing#complete-workflow%3A-content-editing)
```
...
## ​Example Usage
[​](https://docs.mem0.ai/cookbooks/operations/content-writing#example-usage)
```
...
## ​Expected Output
[​](https://docs.mem0.ai/cookbooks/operations/content-writing#expected-output)
### ​Original Document
[​](https://docs.mem0.ai/cookbooks/operations/content-writing#original-document)
```
Project Proposal
...
### ​Edited Document
[​](https://docs.mem0.ai/cookbooks/operations/content-writing#edited-document)
```
# Project Proposal
...
```
[Control Memory IngestionFilter and curate content examples to maintain consistent writing style.](https://docs.mem0.ai/cookbooks/essentials/controlling-memory-ingestion)
## Control Memory Ingestion
[Email Automation with Mem0Automate email drafting with memory-powered context and tone matching.](https://docs.mem0.ai/cookbooks/operations/email-automation)
