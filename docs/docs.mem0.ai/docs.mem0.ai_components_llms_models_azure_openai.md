...
## ​Usage
[​](https://docs.mem0.ai/components/llms/models/azure_openai#usage)
```
import os
...
## ​Config
[​](https://docs.mem0.ai/components/llms/models/azure_openai#config)`azure_openai`[Master List of All Params in Config](https://docs.mem0.ai/components/llms/config)