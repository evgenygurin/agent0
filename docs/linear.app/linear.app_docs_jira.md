...
Once configured, Jira Sync will create issues in Linear when issues are created in a synced Jira space. Issues belonging to that synced pspace from before the sync was configured will not create issues in Linear.
